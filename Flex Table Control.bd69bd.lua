...
function refreshSurface()
    obj_surface = getObjectFromGUID(Global.getVar("mat_GUID"))
end
function onSave()
...
function onload(saved_data)
    ...
    exportObj = getObjectFromGUID(Global.getVar("extractTerrain_GUID"))
    --Establish references to table parts
    obj_leg1 = getObjectFromGUID(Global.getVar("tableLeg1_GUID"))
    obj_leg2 = getObjectFromGUID(Global.getVar("tableLeg2_GUID"))
    obj_leg3 = getObjectFromGUID(Global.getVar("tableLeg3_GUID"))
    obj_leg4 = getObjectFromGUID(Global.getVar("tableLeg4_GUID"))
    obj_surface = getObjectFromGUID(Global.getVar("mat_GUID"))
    obj_surface2 = getObjectFromGUID(Global.getVar("felt_GUID"))
    obj_side_top = getObjectFromGUID(Global.getVar("tableSideTop_GUID"))
    obj_side_bot = getObjectFromGUID(Global.getVar("tableSideBottom_GUID"))
    obj_side_lef = getObjectFromGUID(Global.getVar("tableSideLeft_GUID"))
    obj_side_rig = getObjectFromGUID(Global.getVar("tableSideRight_GUID"))
...
function createSurfaceButtons()
    ...
    self.createButton({
        ...
        position={2,0,7}, height=440, width=btn_width, font_size=btn_font,
    })
    self.createButton({
...
ref_noninteractable= {
    Global.getVar("tableSideBottom_GUID"),
    ...
    Global.getVar("mat_GUID"),
    Global.getVar("felt_GUID"),
